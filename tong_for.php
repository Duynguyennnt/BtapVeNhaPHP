...
<?php 
    if(isset($_POST["so_dau"]) && isset($_POST["so_cuoi"])){
        ...
        $tg_chan = 0;
        $tg_le = 0;
        for ($index = $_POST["so_dau"]; $index <= $_POST["so_cuoi"]; $index++) {
            $tg += $index;
            $tich = $tich*$index;
            if ($index % 2 == 0) {
                $tg_chan += $index;
...
<td width="169"><label for="textfield"></label>
    <input type="text" name="so_dau" id="textfield" value="<?php echo $_POST["so_dau"]; ?>"/></td>
<td width="152">Số kết thúc</td>
<td width="175"><label for="textfield2"></label>
<input type="text" name="so_cuoi" id="textfield2" value="<?php echo $_POST["so_cuoi"] ?>"/></td>
</tr>
<tr>
...
<td colspan="4"><label for="textfield4"></label>
    <input type="text" name="tong" id="textfield4" value="<?php echo $tg; ?>"/></td>
</tr>
<tr>
<td>Tích các số</td>
...
<td colspan="4"><label for="textfield6"></label>
    <input type="text" name="tong_chan" id="textfield6" value="<?php echo $tg_chan; ?>"/></td>
</tr>
<tr>
<td>Tổng các số lẻ</td>
<td colspan="4"><label for="textfield7"></label>
<input type="text" name="tong_le" id="textfield7" value="<?php echo $tg_le; ?>"/></td>
</tr>
<tr>
